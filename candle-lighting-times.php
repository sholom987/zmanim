...
if($zip_codes != null) {
    ...
    <form method="post" action="">
        ...
        <label for="weeks">Start Date <input id="weeks" name="weeks" type="text" value="74"></input></label><br /><br />
        ...
        <label for="end_times">Get End Times<input id="end_times" name="end_times" type="checkbox" checked></input></label><br /><br />
